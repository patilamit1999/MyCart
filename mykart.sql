...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2022 at 01:38 PM
...
INSERT INTO `admin` (`UID`, `NAME`, `USERNAME`, `PASSWORD`) VALUES
('ec289fb1-b8fb-4fab-ad24-2421f29f71e9', 'ADMIN', 'admin', 'admin');
...
('45b069fb-dd94-4e52-b11c-55a60ed17945', 3, 2);
...
INSERT INTO `coupon` (`COUPON_CODE`, `USAGE_TYPE`, `USAGE_LIMIT`, `START_DATE`, `END_DATE`, `DISCOUNT_PERCENTAGE`) VALUES
('AAABBB', 1, 0, '2018-09-08', '2018-09-08', '10'),
...
INSERT INTO `invoice` (`INVOICE_ID`, `ORDER_ID`, `BASE_AMOUNT`, `DISCOUNT_AMOUNT`, `APPLIED_COUPON`, `TOTAL_AMOUNT`) VALUES
(11, 14, 74000, 37000, 'OFF50', 37000),
...
INSERT INTO `orders` (`ORDER_ID`, `USER_ID`, `TIMESTAMP`) VALUES
(14, '45b069fb-dd94-4e52-b11c-55a60ed17945', '2022-06-19 09:11:54'),
(15, 'f34818ab-e816-4096-b7de-f10de30779be', '2022-06-19 09:11:54'),
(17, 'f34818ab-e816-4096-b7de-f10de30779be', '2022-06-19 09:11:54'),
(18, '45b069fb-dd94-4e52-b11c-55a60ed17945', '2022-06-19 09:11:54');

--
-- Triggers `orders`
--
DELIMITER $$
CREATE TRIGGER `ClearCart` AFTER INSERT ON `orders` FOR EACH ROW DELETE
                 FROM cart
...
INSERT INTO `products` (`ID`, `CATEGORY_ID`, `PRODUCT_NAME`, `PRODUCT_DESCRIPTION`, `PRICE`) VALUES
(1, 1, 'Xiaomi Phone', 'Smartphone', 9500),
...
('45b069fb-dd94-4e52-b11c-55a60ed17945', 'Amit Patil', 'Amit', 'Amit'),
('f34818ab-e816-4096-b7de-f10de30779be', 'Ajit Patil', 'Ajit', 'Ajit');
